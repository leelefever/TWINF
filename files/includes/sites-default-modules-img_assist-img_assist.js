...
function onChangeBrowseBy() {
  ...
  browse = formObj['edit[browse]'].value;
	frames['img_assist_main'].href = BASE_URL + 'index.php?q=img_assist/thumbs/' + browse;
}

function onClickUpload() {
  frames['img_assist_main'].href = BASE_URL + 'index.php?q=img_assist/upload';
}

function onClickStartOver() {
  frames['img_assist_main'].href = BASE_URL + 'index.php?q=img_assist/thumbs/myimages';
}
...
function setHeader(mode) {
	if (currentMode != mode) {
		frames['img_assist_header'].href = BASE_URL + 'index.php?q=img_assist/header/' + mode;
	}
	currentMode = mode;
}
